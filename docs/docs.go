    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/data.InputAddUser"
                        }
                    }
                ],
                "responses": {
        ...
        "/room/": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Input for create room",
                        "name": "InputCreteRoom",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/data.InputCreateRoom"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/data.InputRegisterUser"
                        }
                    }
                ],
                "responses": {
